...
import { DEFAULT_IMAGE } from '../component/constants';
...
import displayStatus from '../component/displayStatus';
        ...
        createPost({
            ...
            onCompleted: ({ createPost }) => {
                if(createPost){
                    ...
                    displayStatus({ type: 'error', msg: "Oops! something went wrong." });
                };
            },
        });
        setOpenCreatePostModal(false);
    ...
    return(
        ...
        {POST && headShotURLs? (
            <>
                {home?<MySideer />:<></>}
                <MyContent>
                    <Modal title={openCreatePostModal?"What's on your mind?":"Edit Your Post"} visible={openCreatePostModal || openEditPostModal} onCancel={handleCloseCreatePostModal} onOk={openCreatePostModal?handleCreatePost:handleEditPost}>
                        <TextArea placeholder="Create Post" rows={4} maxLength={1000}  value={body} onChange={(e) => setBody(e.target.value)} style={{ marginBottom: 12 }}/>
